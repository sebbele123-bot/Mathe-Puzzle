              ...
              {sorted.map((c) => {
                ...
                return (
                  <div key={c.id} className="rounded-xl border flex items-stretch overflow-hidden" style={{ background: "#fff", borderColor: C.line }}>
                    <button onClick={() => onOpen(c.id)} className="shrink-0 flex items-center justify-center px-2.5"
                    ...
                    <button onClick={() => onOpen(c.id)} className="flex-1 min-w-0 text-left px-3 py-2">
                    ...
                    <div className="shrink-0 flex flex-col border-l" style={{ borderColor: C.line }}>
                      ...
                      <button onClick={() => onOpen(c.id)} title="öffnen"
